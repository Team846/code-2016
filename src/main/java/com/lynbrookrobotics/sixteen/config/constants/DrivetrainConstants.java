...
public class DrivetrainConstants {
  ...
  public static double MAX_ROTATIONAL_SPEED = 336.59407295975933 /* deg/s */;

  public static final double SPY_TO_SHOOT = 0;
  public static final double DEFENSE_RAMP_DISTANCE = 23/12D; // 47 inches from front wheel to ramp
