...
public class ShootingPositionConstants {
  ...
  public static final double ONE_FORWARD = (90 + (DISTANCE_WHEEL_BOTTOM / 2))/12;
  public static final double ONE_TURN = LEFT_BATTER_TURN;
  public static final double ONE_FORWARD_SECOND = (85 + UP_BATTER_SHOOT)/12;
  ...
  public static final double FIVE_FORWARD_SECOND = 0; // 9.4 inches without centered, might have to back up
}
