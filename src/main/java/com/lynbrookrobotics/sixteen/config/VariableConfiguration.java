...
/**
 * VariableConfiguration class contains all of robot constants that are configured by a file on the
 * robot. It parses the configuration file and constructs classes that represent each subgroup of
 * constants.
 */
