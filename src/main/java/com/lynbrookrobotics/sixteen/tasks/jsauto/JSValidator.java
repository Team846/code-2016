...
public class JSValidator extends JFrame {
  ...
  private ShooterHardware shooterHardware = new ShooterHardware(null, null, null, null, null, null);
  ...
  private void evaluateJSRoutine(File routineFile) {
    try {
      ...
      FiniteTask task = LoadJavascriptFile.loadReader(bufferedReader, robotHardware, drivetrain);
